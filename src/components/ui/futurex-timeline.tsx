...
const journeySteps: JourneyStep[] = [
  ...
  {
    phase: "Month 9 · Demo Day",
    title: "Pitch to the World",
    description: "Present your startup to investors, mentors, and peers. This is the real thing — a culmination of 9 months of work, learning, and growth. Top fellows earn recognition and opportunities beyond the programme.",
  },
];
