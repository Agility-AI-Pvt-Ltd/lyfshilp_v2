...
const videoReviews = [
  {
    ...
    videoSrc:
      "/videos/reviews/SaveClip.App_AQMJhIvM7WQBkrkh67hRfXwhONUq7o9ABF1f55uAxmvXJKOgWyJ4EEHrRDSJ706bLFCxTbcn3eYJAlkIc-pVdqISnrGQOHTELpykZdo.mp4",
  },
  {
    id: 2,
    name: "NIVAAN'S PARENT",
    role: "Fellowship Alumni",
    videoSrc:
      "/videos/reviews/SaveClip.App_AQNQs6eLhZgbEry77lkYjTozyGFkvRu5akl5YqBuvnKklWsttjAPNf-YU9xltbUNHIZlQ-Sa8jlZ5lHf4Qlcyq4xb-cazvdMb6bTCAg (1) copy.mp4",
  },
  {
    id: 3,
    name: "ADHIRAJ'S PARENT",
    role: "Young Entrepreneur",
    videoSrc:
      "/videos/reviews/SaveClip.App_AQOBNKBzecCUeBSsft4pvUvVrQIb14ahHIm21GXAQbsIzu4NfZkr0sZUgFXPtrzgWtqLCiIH9B1RgclAOWpnzXBWkZhjZ1JjXIpEQFs.mp4",
  },
];
      ...
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="mb-16 flex flex-col md:flex-row md:items-end md:justify-between gap-8">
          ...
          <div className="flex items-center gap-3 pb-2">
            ...
            <span className="text-[13px] font-semibold text-gray-400 font-mono tracking-tight">
              4.9 / 5 · 2,000+ users
            </span>
          </div>
        </div>
